            ...
            <div className="flex flex-col gap-5">
              <div className="flex items-center gap-2">
                ...
                {isLoggedInUserProfile ? (
                  ...
                  <Button className="bg-[#0095F6] hover:bg-[#339ee6] h-8">
                    Follow
                  </Button>
                )}
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Badge className="w-fit flex items-center" variant="secondary">
                  <AtSign className="h-6 w-6 mr-2" />
          ...
          <div className="flex items-center justify-center gap-10 text-sm">
            <span
              ...
              className={clsx(
                "py-3 cursor-pointer",
                activeTab === "posts"
                  ? "font-bold border-t-2 border-t-black"
                  : ""
              )}
            >
              POSTS
